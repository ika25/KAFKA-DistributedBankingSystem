...
/**
 * This class loads the transaction from file to create 
 * dummy transactions 
...
public class IncomingTransactionsReader implements Iterator<Transaction> {
    ...
    /**
     * This method loads the transaction from file into collections List object.
     * These messages are parsed and processed into corresponding topic by bank-api-service
     * @return
     */
